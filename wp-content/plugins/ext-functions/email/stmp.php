...
/* Private Functions */
    ...
    { 
        ...
        //$this->sock = $this->b_fsockopen($this->relay_host, $this->smtp_port, $errno, $errstr, $this->time_out);
//var_dump($this->sock, $this->relay_host.":".$this->smtp_port, $errno, $errstr, $this->time_out);
//var_dump(gethostbyname($this->relay_host));
    ...
    function smtp_sockopen_mx($address)
    {
        ...
        foreach ($MXHOSTS as $host) {
            ...
            //$this->sock = $this->b_fsockopen($host, $this->smtp_port, $errno, $errstr, $this->time_out);
