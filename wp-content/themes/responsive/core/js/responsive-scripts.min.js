    ...
    respond.mediaQueriesSupported = win.matchMedia && win.matchMedia("only all").matches, !respond.mediaQueriesSupported) {
        ...
        applyMedia = function(fromResize) {
            ...
            for (var i in mediastyles) {
                ...
                thisstyle.hasquery && (minnull && maxnull || !(minnull || currWidth >= min) || !(maxnull || max >= currWidth)) || (styleBlocks[thisstyle.media] || (styleBlocks[thisstyle.media] = []), styleBlocks[thisstyle.media].push(rules[thisstyle.rules]))
            }
...
jQuery(document).ready(function($) {
    ...
    $("#widgets .widget_categories ul ul.children").append('<div style="clear:both"></div>');
}),
function($) {
    "use strict";
    $.fn.fitVids = function(options) {
        ...
        return div.className = "fit-vids-style",
        div.innerHTML = "&shy;<style>               .fluid-width-video-wrapper {                 width: 100%;                              position: relative;                       padding: 0;                            }                                                                                   .fluid-width-video-wrapper iframe,        .fluid-width-video-wrapper object,        .fluid-width-video-wrapper embed {           position: absolute;                       top: 0;                                   left: 0;                                  width: 100%;                              height: 100%;                          }                                       </style>",
        ref.parentNode.insertBefore(div, ref),
        options && $.extend(settings, options),
        this.each(function() {
            var selectors = ["iframe[src*='player.vimeo.com']", "iframe[src*='www.youtube.com']", "iframe[src*='www.youtube-nocookie.com']", "iframe[src*='fast.wistia.com']", "embed"];
